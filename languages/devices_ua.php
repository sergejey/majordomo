...
//----
    ...
    'DEVICES_LINK_SWITCH_IT_DESCRIPTION' => 'Керування іншим пристроєм за подією',
   ...
   /* DVR camera*/
    ...
    'DEVICES_DVRCAMERA_STREAM_URL' =>'URL відео-потоку',
    'DEVICES_DVRCAMERA_SNAPSHOT' =>'Знімок',
    'DEVICES_DVRCAMERA_SNAPSHOT_URL' =>'URL знімку з камери',
    'DEVICES_DVRCAMERA_ASPECT_RATIO' =>'Співвідношення сторін кадру',
    'DEVICES_DVRCAMERA_RECOGNITION_LEVEL' =>'Мінімальний рівень розпізнавання обличча (400 - середнє)',
    'DEVICES_DVRCAMERA_TAKE_SNAPSHOT' =>'Зберегти знімок',
    'DEVICES_DVRCAMERA_SNAPSHOT_HISTORY' =>'Історія',
