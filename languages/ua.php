...
$dictionary = array (
	...
	'NEWDASH_DISCONNECTED' => 'Немає підключення',
	...
	'NEWDASH_CONSOLE_ERROR_EMPTY' => 'Ви намагаєтеся відправити порожню команду!',
	'NEWDASH_CONSOLE_ERROR_FAIL' => 'Здається ви відправляєте невірну команду ...',
	'NEWDASH_LOADING' => 'Завантажуємо дані ...',
	'NEWDASH_SYSTEM_INFO' => 'Інформація про систему',
	'NEWDASH_SYSTEM_INFO_DB_STATUS' => 'Підключення до БД',
	'NEWDASH_SYSTEM_INFO_BRABCH' => 'Поточна гілка',
	'NEWDASH_SYSTEM_INFO_LAST_UPDATE' => 'Останнє оновлення',
	'NEWDASH_CYCLE_CONTROL' => 'Контроль циклів',
	'NEWDASH_LAST_SCRIPTS' => 'Останнє сценарії',
	'NEWDASH_LAST_SCRIPTS_GO' => 'сценарії',
	'NEWDASH_HELLO_NEW' => 'Привіт новий дизайн!',
	'NEWDASH_HELLO_NEW_TEXT' => 'Ми тут затіяли оновлення дизайну і нам потрібна твоя допомога! Збирай баги, зауваження і побажання і пиши їх на форум! Давай разом зробимо MajorDomo красивим і зручним =) ',
	'NEWDASH_HELLO_NEW_BTN' => 'На форум!',
	'NEWDASH_CONNECT_ADS' => 'Підключай Connect!',
	'NEWDASH_CONNECT_ADS_BTN' => 'Що входить і скільки коштує?',
	'NEWDASH_CONNECT_ADS_TEXT' => 'MajorDomo - це OpenSource проект. Він розробляється, підтримується і распростроняется абсолютно безкоштовно. Підключаючи пакет послуг Connect-Pack ви допомагаєте розробнику, а так само отримуєте додаткові функції для роботи з MajorDomo. Всім новим користувачам 14 днів безкоштовно!',
	'NEWDASH_CONNECT_ADS_DONATE' => 'Допомогти разово',
	'NEWDASH_CONNECT_ADS_DONATE_BTN' => 'Хочу допомогти разово',
	'NEWDASH_CONNECT_ADS_DONATE_TEXT' => "Класно, що ви хочете допомогти MajorDomo! Ви можете зробити разовий переклад розробнику системи. Для цього, перейдіть <a href=&quot;https://connect.smartliving.ru/members/finance.html&quot; target=&quot;_blank&quot;><b>по ссылке</b></a> і поповните баланс в системі Connect. Далі просто переведіть гроші зі свого балансу в натиснувши кнопку <a href=&quot;https://connect.smartliving.ru/tasks/1.html?support=1&quot; target=&quot;_blank&quot;><b>эту задачу</b></a> нажав кнопку &quot;Поддержать разработку&quot;.",
    'NEWDASH_CLASS' => 'Клас',
	'NEWDASH_NEWS' => 'Новини і блоги MajorDomo',
	'NEWDASH_NEWS_MORE' => 'ще записи',
	'NEWDASH_DONTSHOW_THIS_BLOCK' => 'Не показувати цей блок',
	'NEWDASH_HIDE_MENU_HINT' => 'Це меню можна перемістити вгору, спробуємо? <br> Щоб повернути назад натисніть',
	'NEWDASH_PRELOAD_HEADER' => 'Завантажуємо вміст ...',
	'NEWDASH_PRELOAD_TEXT' => 'Якщо завантаження занадто довга, то можливо в коді є помилка або скрипт занадто довго виконує запитану операцію.',
	'NEWDASH_PRELOAD_BTN' => 'Зупинити операцію',
	'NEWDASH_UPDATE_MODULE_HINT1' => 'Оновлення для',
	'NEWDASH_UPDATE_MODULE_HINT2' => 'модулів',

	'NEWSAVERESTORE_NONE_UPDATE_HEADER' => 'Всі добре!',
	'NEWSAVERESTORE_NONE_UPDATE_TEXT' => 'Класно, що ви вчасно оновлюєтеся. Зараз у вас остання доступна версія системи. Але в разі необхідності, ви можете перекачати файли з сховища GitHub. ',
	'NEWSAVERESTORE_NONE_UPDATE_BTN' => 'Все одно оновити',
	'NEWSAVERESTORE_UPDATE_HEADER' => 'Пора оновитися!',
	'NEWSAVERESTORE_UPDATE_TEXT' => 'Намагайтеся регулярно оновлювати систему, щоб уникнути помилок і проблем з безпекою. Кожен день розробники вносять зміни, щоб ви могли отримати максимальне задоволення при роботі з MajorDoMo. ',
	'NEWSAVERESTORE_UPDATE_BTN' => 'Оновити систему',
	'NEWSAVERESTORE_DOWNLOAD_GIT_ARHIVE' => 'Завантажити архів',
	'NEWSAVERESTORE_CONSOLE' => 'Консоль MajorDoMo',
	'CLOSE' => 'Закрити',
	'NEWSAVERESTORE_RESTORE_ARHIVE' => 'Резервні копії',
	'NEWSAVERESTORE_RESTORE_DOWNANDRESTORE' => 'Завантажити та відновити',
	'NEWSAVERESTORE_RESTORE_RESTOREINARHIVE' => 'Відновити з архіву системи',
	'NEWSAVERESTORE_RESTORE_CREATE_RESTORE' => 'Створити резеврную копію',
	'NEWSAVERESTORE_BACKUP_HINT' => 'Оберіть розділи системи для створення резервних копій.',
	'NEWSAVERESTORE_CHOUSE_FILE' => 'Оберіть файл',
	'NEWSAVERESTORE_CHOUSES_FILES' => 'Обрано файлів:',
	...
	'UPDATEBACKUP_CLOSE_CONSOLE_AUTO' => 'Консоль буде закрита автоматично ...',
	'UPDATEBACKUP_GET_REDIRECT' => 'Запит редиректу ...',
	'UPDATEBACKUP_GET_REDIRECT_TO_MERKET' => 'Запит редиректу в маркет доповнень ...',
	'UPDATEBACKUP_UPDATE_GET_DONE' => 'Оновлення встановлено!',
	'UPDATEBACKUP_REQUEST_REBOOT' => 'Запит перезавантаження MajorDoMo',
	'UPDATEBACKUP_REBOOT_WELL_DONE' => 'Система перезавантажена!',
	'UPDATEBACKUP_ERROR_DOWNLOAD' => 'Неможливо завантажити архів! Операція буде зупинена! ',
	'UPDATEBACKUP_APPLY_UPDATE' => 'Застосовуємо оновлення ...',
	'UPDATEBACKUP_RESTORE_DB_FOR' => 'Відновлюємо базу даних з',
	'UPDATEBACKUP_RESTORE_DB' => 'Відновлюємо базу даних',
	'UPDATEBACKUP_RESTORE_DB_DONE' => 'База даних відновлена!',
	'UPDATEBACKUP_UNPACKEGE_FROM_TO' => 'Розпакування файлів з',
	'UPDATEBACKUP_UNPACKEGE' => 'Розпакування',
	'UPDATEBACKUP_DISABLED' => 'Відключаємо',
	'UPDATEBACKUP_PATCHING' => 'патч',
	'UPDATEBACKUP_CHECK_MODULE_UPDATE' => 'Перевіряємо оновлення модулів ...',
	'UPDATEBACKUP_APPLY_CHANGES' => 'Застосовуємо зміни',
	'UPDATEBACKUP_REQUEST_BACKUP_CREATE' => 'Запит створення резервної копії',
	'UPDATEBACKUP_SAVE_DESIGN' => 'Зберігаємо дизайн ...',
	'UPDATEBACKUP_SAVE_CODE' => 'Зберігаємо код ...',
	'UPDATEBACKUP_SAVE_DATA' => 'Зберігаємо дані ...',
	'UPDATEBACKUP_SAVE_FILES' => 'Зберігаємо файли ...',
	'UPDATEBACKUP_BACKUP_PACKEGE_TO' => 'Резервна копія пакується в архів:',
	'UPDATEBACKUP_COPY_TO' => 'Копіюємо в',
