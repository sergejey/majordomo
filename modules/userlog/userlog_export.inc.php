...
$qry = count($ids) ? " userlog.ID IN (".implode(',', $ids).")" : " 1";

$tmp = SQLSelect("SELECT admin_users.NAME as USER, userlog.MESSAGE, userlog.IP, DATE_FORMAT(ADDED, '%m/%d/%Y %H:%i:%s') as ADDED 
