...
{
saySafe(LANG_ALERT.' '.mb_strtolower(LANG_SENSOR_ALARM).' '.mb_strtolower(LANG_DEVICES_SMOKE_SENSOR).' '.LANG_IN.' '.mb_strtolower($loc) , 2); 
//say('111', 2); 
}
else 
{saySafe(LANG_DEVICES_SMOKE_SENSOR.' '.LANG_IN.' '.mb_strtolower($loc).' ' .LANG_SENSOR_NORMAL, 2); 
}
}
}
