      ...
      */
      ...
      if ($ajax != '') 
      {
         ...
         if ($command != '') 
         {
            ...
            {
               $vPlayerUrl = "http://" . $terminal['HOST'] . ":" . $terminal['PLAYER_PORT'];
               ...
               {
                  curl_setopt($ch, CURLOPT_URL, $vPlayerUrl . "/rc/?command=vlc_fullscreen");
                  $res = curl_exec($ch);
               }

               if ($command == 'pause') 
               {
                  curl_setopt($ch, CURLOPT_URL, $vPlayerUrl . "/rc/?command=vlc_pause");
                  $res = curl_exec($ch);
               }

               if ($command == 'next') 
               {
                  curl_setopt($ch, CURLOPT_URL, $vPlayerUrl . "/rc/?command=vlc_next");
                  $res = curl_exec($ch);
               }

               if ($command == 'prev') 
               {
                  curl_setopt($ch, CURLOPT_URL, $vPlayerUrl . "/rc/?command=vlc_prev");
                  $res = curl_exec($ch);
               }

               if ($command == 'close') 
               {
                  curl_setopt($ch, CURLOPT_URL, $vPlayerUrl . "/rc/?command=vlc_close");
                  $res = curl_exec($ch);
               }
            } 
