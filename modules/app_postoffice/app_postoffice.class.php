 ...
 *
 * @package PostOffice
 * @author LDV <palacex@gmail.com> http://silvergate.ru/
 * @version 0.1
 */
...
class app_postoffice extends module 
{
   ...
   function app_postoffice() 
   {
      ...
      $this->title="<#LANG_APP_POSTOFFICE#>";
   ...
   function admin(&$out) 
   {
      if (isset($this->data_source) && !$_REQUEST['data_source']) 
    ...
    * @access private
    */
   function buildTree_product_categories
     ($res, $parent_id = 0, $level = 0) 
   {
      $total = count($res);
      $res2  = array();
    ...
    * @access private
    */
   function updateTree_product_categories
     ($parent_id = 0, $parent_list = '') 
   {
