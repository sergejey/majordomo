	...
	function renderGrid(r, c, colFormat, showNumbers, fetchEvents) {
		...
		if (!tbody) { // first time, build all cells from scratch
			...
			for (i=0; i<rowCnt; i++) {
				...
				for (j=0; j<colCnt; j++) {
					s += "<td class='fc-" +
						...
						' fc-not-today') + "'>" +
						"<div class='fc-add-task'><a href='/projects/tasks/edit/?calendar_date=" + d.getTime() + "'><img src='/img/ico14.gif' alt='add task' /></a></div>" +
			...
			tbody.find('td').each(function() {
				...
				td.find('div.fc-add-task').html("<a href='/projects/tasks/edit/?calendar_date=" + d.getTime() + "'><img src='/img/ico14.gif' alt='add task' /></a>");
